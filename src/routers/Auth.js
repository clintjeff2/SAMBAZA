  ...
  return (
    <>
        <Routes>
            ...
            <Route path='/dashboard/authentication/reset-password' element={ < ResetPassword /> } />
            <Route path='/dashboard/authentication/recover-password' element={ < RecoverPassword /> } />
            <Route path='/dashboard/authentication/confirm-email' element={ < ConfirmMail /> } />
            <Route path='/dashboard/authentication/lock-screen' element={ < LockScreen /> } />
        </Routes>
    </>
  )
}
